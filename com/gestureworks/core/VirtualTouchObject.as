package com.gestureworks.core
{
	 ...
	 * required format.</p> 
	 */
	public class VirtualTouchObject extends Sprite
	{
		/**
		 * @private
		 */
		...
		public function set touchChildren(value:Boolean):void
		{
			...
			if (value) target.mouseChildren = true;
			else target.mouseChildren = false;
		}
		...
		*/
		...
		public function assignPoint(event:TouchEvent):void // asigns point
		{
			...
			var pointObject:PointObject  = new PointObject();	
				...
				else if (GestureWorks.activeSim) MouseManager.gw_public::registerMousePoint(event);
		...
		override public function addEventListener(type:String, listener:Function, useCapture:Boolean = false, priority:int = 0, useWeakReference:Boolean = false):void 
		{
			...
			{				
				super.addEventListener(GWTouchEvent.eventType(type), function(e:*):void {
					this.dispatchEvent(new GWTouchEvent(e));
				});
			}
