		...
		<Gesture_set gesture_set_name="n-manipulate">
			...
			<Gesture id="swipe" type="swipe">
				...
				<processing>
					...
					<inertial_filter>
						<property ref="swipe_dx" touch_inertia="true" inertial_mass="3" release_inertia="true" friction="0.99999"/>
						<property ref="swipe_dy" touch_inertia="true" inertial_mass="3" release_inertia="true" friction="0.99999"/>
					</inertial_filter>
				</processing>
				<mapping>
					<update>
						<gesture_event>
							...
							<property ref="swipe_dy" target="" func="linear" factor="1" delta_threshold="flase" delta_min="0.0001" delta_max="1"/>
						</gesture_event>
					</update>
				</mapping>
			</Gesture>
