...
package com.gestureworks.objects 
{
	...
	public class TransformObject extends Object 
	{
		...
		public function get localz():Number{	return _localz;}
		public function set localz(value:Number):void{	_localz = value;}
		...
		public function get obj_x():Number{	return _obj_x;}
		public function set obj_x(value:Number):void{	_obj_x = value;}
		// y---------------------
		private var _obj_y:Number = 0;
		public function get obj_y():Number{	return _obj_y;}
		public function set obj_y(value:Number):void{	_obj_y = value;}
		// z---------------------3d//
		private var _obj_z:Number = 0;
		public function get obj_z():Number{	return _obj_z;}
		public function set obj_z(value:Number):void{	_obj_z = value;}
		
		// width----------------------
		private var _obj_width:Number = 0;
		public function get obj_width():Number{	return _obj_width;}
		public function set obj_width(value:Number):void{	_obj_width = value;}
		// height---------------------
		private var _obj_height:Number = 0;
		public function get obj_height():Number{return _obj_height;}
		public function set obj_height(value:Number):void{	_obj_height = value;}
		// length---------------------3d//
		private var _obj_length:Number = 0;
		public function get obj_length():Number{	return _obj_length;}
		public function set obj_length(value:Number):void{	_obj_length = value;}
		
		// scaleX------------------
		private var _obj_scaleX:Number = 0;
		public function get obj_scaleX():Number{	return _obj_scaleX;}
		public function set obj_scaleX(value:Number):void{	_obj_scaleX = value;}
		// scaleY------------------
		private var _obj_scaleY:Number = 0;
		public function get obj_scaleY():Number{	return _obj_scaleY;}
		public function set obj_scaleY(value:Number):void{	_obj_scaleY = value;}
		// scaleZ------------------3d//
		private var _obj_scaleZ:Number = 0;
		public function get obj_scaleZ():Number{	return _obj_scaleZ;}
		public function set obj_scaleZ(value:Number):void{	_obj_scaleZ = value;}
		
		// rotation---------------------
		private var _obj_rotation:Number = 0;
		public function get obj_rotation():Number{	return _obj_rotation;}
		public function set obj_rotation(value:Number):void{	_obj_rotation = value;}
		// rotationX---------------------
		private var _obj_rotationX:Number = 0;
		public function get obj_rotationX():Number{	return _obj_rotationX;}
		public function set obj_rotationX(value:Number):void{	_obj_rotationX = value;}
		// rotationY---------------------
		private var _obj_rotationY:Number = 0;
		public function get obj_rotationY():Number{	return _obj_rotationY;}
		public function set obj_rotationY(value:Number):void{	_obj_rotationY = value;}
		// rotationZ---------------------
		private var _obj_rotationZ:Number = 0;
		public function get obj_rotationZ():Number{	return _obj_rotationZ;}
		public function set obj_rotationZ(value:Number):void{	_obj_rotationZ = value;}
		...
		public function get dalpha():Number{	return _dalpha;}
		public function set dalpha(value:Number):void{	_dalpha = value;}
		...
		public function get pre_init_height():Number{	return _pre_init_height;}
		public function set pre_init_height(value:Number):void{	_pre_init_height = value;}
		// pre_init_width ------------------
		private var _pre_init_width:Number = 0;
		public function get pre_init_width():Number{	return _pre_init_width;}
		public function set pre_init_width(value:Number):void{	_pre_init_width = value;}
		// transformPointOn ------------------
		private var _init_center_point:Boolean = false;
		public function get init_center_point():Boolean{	return _init_center_point;}
		public function set init_center_point(value:Boolean):void{	_init_center_point = value;}
		// transformPointOn ------------------
		private var _transformPointsOn:Boolean = false;
		public function get transformPointsOn():Boolean{	return _transformPointsOn;}
		public function set transformPointsOn(value:Boolean):void{	_transformPointsOn = value;}
		// debug points 
