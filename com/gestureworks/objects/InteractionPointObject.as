...
package com.gestureworks.objects 
{
	...
	{	
		...
		public var type_attribute:String = new String();
		
		//input device type
		public var deviceType:String = new String();
		// device source when more than one of the same type
		...
		public var handside:String = new String("undefined");
		...
		//point radius can be used for palm,
