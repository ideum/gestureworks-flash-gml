...
package com.gestureworks.utils.debug
{
	...
	public class DebugClusterDataView extends Sprite
	{	
		...
		private var chart_cluster_delta:Sprite = new Sprite();
		private var line_cluster_delta:Sprite = new Sprite();
		...
		public function DebugClusterDataView(touchObjectID:Number)
		{
		...
		public function init():void
		{
			...
			//NumPoints = GestureGlobals.N;
			
			GestureGlobals.clusterHistoryCaptureLength = obj.chart_history;
			hist = GestureGlobals.clusterHistoryCaptureLength;
			...
			//////////////////////////////////////////////////////////////////////////////////////////////
					...
					if (headerOn) {
						...
						var txt_name:AddSimpleText = new AddSimpleText(obj.width,th+4,"center", obj.text_color, int(obj.text_size)+4);
							txt_name.textCont = "Cluster Analysis";
							txt_name.x = shiftx;
							txt_name.y = 0;
					...
					if (positionOn) {
						...
						var txt_position:AddSimpleText = new AddSimpleText(des_w,th,"right", obj.text_color, obj.text_size);
							txt_position.textCont = "LOCATION";
					...
					if (dimentionOn) {
						...
						var txt_dimension:AddSimpleText = new AddSimpleText(des_w,th,"right",  obj.text_color, obj.text_size);
							txt_dimension.textCont = "DIMENSIONS";
					...
					if (separationOn) {
						...
						var txt_separation:AddSimpleText = new AddSimpleText(des_w,th,"right",  obj.text_color, obj.text_size);
							txt_separation.textCont = "SEPARATION";
					...
					if (rotationOn) {
						...
						var txt_rotation:AddSimpleText = new AddSimpleText(des_w,th,"right",  obj.text_color, obj.text_size);
							txt_rotation.textCont = "ORIENTATION";
						...
						var txt_rotation_sgn:AddSimpleText = new AddSimpleText(var_w,th,"right",  obj.text_color, obj.text_size);
							txt_rotation_sgn.textCont = "th";// String.fromCharCode(952); //String.fromCharCode(186);//String.fromCharCode(3B8); //'<&#3B8>'; //;//δ Ψ
						...
						if (deltaChartOn)
						{
							//n_chart++;
								// position chart
								chart_cluster_delta.x = 0//margin/ 2;
								chart_cluster_delta.y = n*linet + 5;
							
								// draw header
								chart_cluster_delta.graphics.lineStyle(obj.stroke_thickness, obj.stroke_color, obj.stroke_alpha);
								chart_cluster_delta.graphics.beginFill(fillColorB, obj.fill_alpha);
								chart_cluster_delta.graphics.drawRect(0,0, obj.width, header_h);
								chart_cluster_delta.graphics.endFill();
								...
								var txt_chart_name:AddSimpleText = new AddSimpleText(obj.width,th+4,"center", obj.text_color, int(obj.text_size)+4);
									txt_chart_name.textCont = "Cluster Deltas";
									txt_chart_name.x = shiftx;
									txt_chart_name.y = 0;
								chart_cluster_delta.addChild(txt_chart_name);
								
								// draw back ground
								chart_cluster_delta.graphics.beginFill(fillColorB, obj.fill_alpha);
								chart_cluster_delta.graphics.drawRoundRect(margin*0.5, header_h + margin*0.5, w0-margin, h0-margin,0);
								chart_cluster_delta.graphics.endFill();
								
								//draw axis horizontal
								chart_cluster_delta.graphics.lineStyle(1, 0xFFFFFF, 1);
								chart_cluster_delta.graphics.moveTo(w0-(margin*0.5)-key_width,header_h+(h0*0.5));
								chart_cluster_delta.graphics.lineTo(margin * 0.5, header_h + (h0 * 0.5));
								//draw axis vertical
								chart_cluster_delta.graphics.moveTo(margin*0.5 + origin_shift,header_h+margin*0.5);
								chart_cluster_delta.graphics.lineTo(margin * 0.5 + origin_shift, header_h + h0 - margin*0.5);
								// set origin value
								...
								chart_cluster_delta.addChild(txt_orign);
								
								// position chart line object
								line_cluster_delta.y = header_h; 
								line_cluster_delta.x = margin*0.5 + origin_shift;
								chart_cluster_delta.addChild(line_cluster_delta);
								...
								chart_cluster_delta.addChild(txt_dx);
								...
								chart_cluster_delta.addChild(txt_dy);
								...
								chart_cluster_delta.addChild(txt_dsx);
								...
								chart_cluster_delta.addChild(txt_dsy);
								...
								chart_cluster_delta.addChild(txt_dtheta);
								
								// create key lines
								
								chart_cluster_delta.graphics.lineStyle(1, dx_color, 1);
								chart_cluster_delta.graphics.moveTo(w0-(margin*0.5)-key_width + 10, header_h + 0.6*shift_key + margin*0.5);
								chart_cluster_delta.graphics.lineTo(w0 - (margin * 0.5)-key_text_width, header_h + 0.6*shift_key + margin*0.5);
								
								chart_cluster_delta.graphics.lineStyle(1, dy_color, 1);
								chart_cluster_delta.graphics.moveTo(w0-(margin*0.5)-key_width + 10 ,header_h + 1.6*shift_key+ margin*0.5);
								chart_cluster_delta.graphics.lineTo(w0 - (margin * 0.5)-key_text_width, header_h + 1.6*shift_key + margin*0.5);
								
								chart_cluster_delta.graphics.lineStyle(1, dsx_color, 1);
								chart_cluster_delta.graphics.moveTo(w0-(margin*0.5)-key_width + 10 ,header_h + 2.6*shift_key+ margin*0.5);
								chart_cluster_delta.graphics.lineTo(w0 - (margin * 0.5)-key_text_width, header_h + 2.6*shift_key+ margin*0.5 );
								
								chart_cluster_delta.graphics.lineStyle(1, dsy_color, 1);
								chart_cluster_delta.graphics.moveTo(w0-(margin*0.5)-key_width+ 10 ,header_h + 3.6*shift_key+ margin*0.5);
								chart_cluster_delta.graphics.lineTo(w0 - (margin * 0.5)-key_text_width, header_h + 3.6*shift_key+ margin*0.5 );
								
								chart_cluster_delta.graphics.lineStyle(1, dtheta_color, 1);
								chart_cluster_delta.graphics.moveTo(w0 - (margin * 0.5) - key_width + 10 , header_h + 4.6*shift_key+ margin*0.5);
								chart_cluster_delta.graphics.lineTo(w0-(margin*0.5)-key_text_width, header_h + 4.6*shift_key + margin*0.5);
								
							listHolder.addChild(chart_cluster_delta);	
						}
	}
	...
	{	
		...
		_x = clusterObject.x;
		_y = clusterObject.y;
		_w = clusterObject.width;
		_h = clusterObject.height;
		_r = clusterObject.radius;
		sepx = clusterObject.separationX;
		sepy = clusterObject.separationY;
		...
		// set position values
		if (positionOn) {
			listObject.x_value.textCont = Math.round(_x);
			listObject.y_value.textCont = Math.round(_y);
		...
		if (dimentionOn) {
			listObject.w_value.textCont = Math.round(_w);
			listObject.h_value.textCont = Math.round(_h);
		...
		if (separationOn) {
			listObject.scalex_value.textCont =  Math.round(sepx);//Math.round(separation);
			listObject.scaley_value.textCont =  Math.round(sepy);//Math.round(separation);
		...
		if (rotationOn) {
			listObject.rotation_value.textCont =  Math.round(rot);//Math.round(rotation);
	...
	if (deltaChartOn) {
			...
			//////////////////////////////////////////////////////////////////////////////////////////////////////
					...
					line_cluster_delta.graphics.clear();
					...
					for (q = 0; q < hist; q++) {
						...
						if (q+1<hist-1) 
						{
							...
							line_cluster_delta.graphics.lineTo( q * xscale,  y0 +(h0*0.5));
							line_cluster_delta.graphics.lineTo( (q+1) * xscale, y1 + (h0*0.5));
						}
					}
					
					// draw cluster data dy
					line_cluster_delta.graphics.lineStyle(1, dy_color, 1);
					...
					line_cluster_delta.graphics.lineStyle(1,dsx_color, 1);
					line_cluster_delta.graphics.moveTo(0, h0*0.5);
					...
					line_cluster_delta.graphics.lineStyle(1, dsy_color, 1);
					line_cluster_delta.graphics.moveTo(0, h0 *0.5);
					...
					for (q = 0; q < hist; q++) {
						...
						if (q+1<hist) 
						{
							...
							line_cluster_delta.graphics.lineTo( q * xscale ,  y0 + h0 / 2);
							line_cluster_delta.graphics.lineTo( (q+1) * xscale , y1 + h0 / 2);
						}
					}
					
					// draw cluster data dtheta
					line_cluster_delta.graphics.lineStyle(1, dtheta_color, 1);
					line_cluster_delta.graphics.moveTo(0, h0*0.5);
